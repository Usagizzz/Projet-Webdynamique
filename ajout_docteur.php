...
<?php include('entete.php'); ?>
	...
	<div class="recipient_reg" style="background-color:#272327;">
		<h3 class="text-center" style="background-color:#272327;color: #fff;">Ajouter un médecin</h3>
		...
		<form enctype="multipart/form-data" method="post" class="text-center" style="margin-left: 110px">
			 <div class="col-md-12">
					...
					<button name="submit" type="submit" style="margin-left:148px;margin-top: 4px;width:95px;border-radius: 3px;height: 30px">Ajouter</button> <br>
			...
			<?php
						if(isset($_POST['submit'])){
							...
							if ($conn->query($sql) == TRUE) {
							    echo "<script>alert('Un nouveau docteur a bien été enregistré');</script>";
							} else {
							    echo "<script>alert('Il y a une erreur d'enregistrement essayer plus tard)<script>";
							}
